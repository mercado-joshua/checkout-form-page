...
## Description
### Purpose:
A finished coding challenge from [devChallenges.io](https://devchallenges.io/challenges/0J1NxxGhOUYVqihwegfO).
...
* A bit of **Javascript** for form validation
* A bit of **JQuery** for input-spinner
